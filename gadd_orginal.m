...
disp(sprintf('标准遗传算法 Standard GA(SGA)'));
...
% if bi==2
%     subplot(4,1,2);
%     boxplot([d(:,(ger-1)),d(:,(2*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('SGA');
%     hold on;
% else if bi==3
%         subplot(4,1,2);
%         boxplot([d(:,(ger-1)),d(:,(2*ger-1)),d(:,(3*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('SGA');
%         hold on;
%     else if bi==4
%             subplot(4,1,2);
%             boxplot([d(:,(ger-1)),d(:,(2*ger-1)),d(:,(3*ger-1)),d(:,(4*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('SGA');
%             hold on;
%             else if bi==5
%                 subplot(4,1,2);
%                 boxplot([d(:,(ger-1)),d(:,(2*ger-1)),d(:,(3*ger-1)),d(:,(4*ger-1)),d(:,(5*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('SGA');
%                 hold on;
%                 else if bi==6
%                     subplot(4,1,2);
%                     boxplot([d(:,(ger-1)),d(:,(2*ger-1)),d(:,(3*ger-1)),d(:,(4*ger-1)),d(:,(5*ger-1)),d(:,(6*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('SGA');
%                     hold on;
%                     end
%                 end
%         end
...
% if bi==2
%     subplot(4,1,2);
%     boxplot([ave(:,(ger-1)),ave(:,(2*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('SGA');
%     hold on;
% else if bi==3
%         subplot(4,1,2);
%         boxplot([ave(:,(ger-1)),ave(:,(2*ger-1)),ave(:,(3*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('SGA');
%         hold on;
%     else if bi==4
%             subplot(4,1,2);
%             boxplot([ave(:,(ger-1)),ave(:,(2*ger-1)),ave(:,(3*ger-1)),ave(:,(4*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('SGA');
%             hold on;
%             else if bi==5
%                 subplot(4,1,2);
%                 boxplot([ave(:,(ger-1)),ave(:,(2*ger-1)),ave(:,(3*ger-1)),ave(:,(4*ger-1)),ave(:,(5*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('SGA');
%                 hold on;
%                 else if bi==6
%                     subplot(4,1,2);
%                     boxplot([ave(:,(ger-1)),ave(:,(2*ger-1)),ave(:,(3*ger-1)),ave(:,(4*ger-1)),ave(:,(5*ger-1)),ave(:,(6*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('SGA');
%                     hold on;
%                     end
%                 end
%         end
