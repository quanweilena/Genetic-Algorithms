...
sol1=1;  it = 1;updatef=1;d=[];ave=[];xd=[];theshold=[];dead=[];xave=[];E=[];sss=floor(1/p1);
GER=300;
ger =100;%代数
ri=0.1;%随机移民比例
R=ri*N;%随机移民数量
...
hold on;
subplot(211);
plot(xd,'g','linewidth',1.5),xlabel('进化代数'),ylabel('最佳适应度');
legend('RRGA','SGA','RIGA','EIGA');
subplot(212);
hold on;
plot(xave,'g','linewidth',1.5),xlabel('进化代数'),ylabel('平均适应度');
legend('RRGA','SGA','RIGA','EIGA');
...
% if bi==2
%     subplot(4,1,4);
%     boxplot([d(:,(ger-1)),d(:,(2*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('EIGA');
%     hold on;
% else if bi==3
%         subplot(4,1,4);
%         boxplot([d(:,(ger-1)),d(:,(2*ger-1)),d(:,(3*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('EIGA');
%         hold on;
%     else if bi==4
%             subplot(4,1,4);
%             boxplot([d(:,(ger-1)),d(:,(2*ger-1)),d(:,(3*ger-1)),d(:,(4*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('EIGA');
%             hold on;
%             else if bi==5
%                 subplot(4,1,4);
%                 boxplot([d(:,(ger-1)),d(:,(2*ger-1)),d(:,(3*ger-1)),d(:,(4*ger-1)),d(:,(5*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('EIGA');
%                 hold on;
%                 else if bi==6
%                     subplot(4,1,4);
%                     boxplot([d(:,(ger-1)),d(:,(2*ger-1)),d(:,(3*ger-1)),d(:,(4*ger-1)),d(:,(5*ger-1)),d(:,(6*ger-1))]),xlabel('环境'),ylabel('最佳适应度'),title('EIGA');
%                     hold on;
%                     end
%                 end
%         end
...
% if bi==2
%     subplot(4,1,4);
%     boxplot([ave(:,(ger-1)),ave(:,(2*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('EIGA');
%     hold on;
% else if bi==3
%         subplot(4,1,4);
%         boxplot([ave(:,(ger-1)),ave(:,(2*ger-1)),ave(:,(3*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('EIGA');
%         hold on;
%     else if bi==4
%             subplot(4,1,4);
%             boxplot([ave(:,(ger-1)),ave(:,(2*ger-1)),ave(:,(3*ger-1)),ave(:,(4*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('EIGA');
%             hold on;
%             else if bi==5
%                 subplot(4,1,4);
%                 boxplot([ave(:,(ger-1)),ave(:,(2*ger-1)),ave(:,(3*ger-1)),ave(:,(4*ger-1)),ave(:,(5*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('EIGA');
%                 hold on;
%                 else if bi==6
%                     subplot(4,1,4);
%                     boxplot([ave(:,(ger-1)),ave(:,(2*ger-1)),ave(:,(3*ger-1)),ave(:,(4*ger-1)),ave(:,(5*ger-1)),ave(:,(6*ger-1))]),xlabel('环境'),ylabel('平均适应度'),title('EIGA');
%                     hold on;
%                     end
%                 end
%         end
